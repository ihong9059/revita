/*
 * ADC battery voltage test - Node (Link)
 *
 * Link BAT_AIN: P0.31 = AIN7
 * 분압: 1M / 1M → 보정 배수 = 2
 *
...
int main(void)
{
	...
	printk("\n========================================\n");
	printk("  ADC Battery test - Node (Link)\n");
	printk("  BAT_AIN: P0.31 (AIN7)\n");
	printk("  Divider: 1M / 1M  → x%d\n", DIVIDER_NUM / DIVIDER_DEN);
